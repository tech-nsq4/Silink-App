...
class CompanyDashboardScreenTmp extends StatelessWidget {
  const CompanyDashboardScreenTmp({super.key});

  void _go(String route) => NavigationService.push(route);
                          ...
                          child: Column(
                            children: [
                              ...
                              _Tile(
                                ...
                                label:
                                    LocaleKeys.company_employees.tr(),
